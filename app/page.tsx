    ...
    <main className="min-h-screen bg-[#0c0d12] text-[#F5F5DC] flex flex-col font-sans relative overflow-x-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
            <div className="bg-[#1e1f20]/60 p-8 rounded-2xl border border-neutral-800/80 hover:border-[#4d6cf7]/30 transition-all duration-300 flex flex-col">
              ...
              <div className="mt-6 pt-6 border-t border-neutral-800/60">
                ...
                <a
                  ...
                  className="mt-4 w-full block text-center py-4 bg-[#4d6cf7] hover:bg-[#3b5de7] text-white font-black text-sm rounded-full transition-all uppercase tracking-widest"
                >
                  Initialize Engine
                </a>
              </div>
            ...
            <div className="bg-[#1e1f20]/80 p-8 rounded-2xl border border-[#4d6cf7]/30 hover:border-[#4d6cf7]/60 transition-all duration-300 flex flex-col relative">
              <div className="absolute -top-3 right-6 bg-[#4d6cf7] text-white text-[10px] font-black px-4 py-1 rounded-full tracking-widest uppercase">
                Most Complete
              </div>
              <div className="flex items-center justify-between mb-4">
          ...
          <p className="text-[12px] text-neutral-600 text-center mt-8 font-mono">
      ...
      <section className="relative z-10 w-full px-6 py-16 border-t border-neutral-900/60">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
            <article className="bg-[#1e1f20]/40 p-8 rounded-2xl border border-neutral-800/80 backdrop-blur-sm hover:border-[#4d6cf7]/30 transition-all duration-300">
      ...
      <section className="relative z-10 w-full px-6 py-16 border-t border-neutral-900/60">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <cite className="block mt-4 text-[#4d6cf7] font-medium not-italic">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/testimonials"
              className="px-6 py-3 bg-[#4d6cf7] hover:bg-[#3b5de7] text-white font-bold text-sm rounded-full transition-all shadow-lg shadow-[#4d6cf7]/25 hover:shadow-[#4d6cf7]/50"
            >
              Read more reviews
            </Link>
            <Link
      ...
      <section className="relative z-10 w-full px-6 py-16 border-t border-neutral-900/60">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <dl className="space-y-6 text-center max-w-2xl mx-auto">
            <div>
              <dt className="text-[#4d6cf7] font-semibold text-center">What is zero-retention?</dt>
              <dd className="text-neutral-400 mt-1 text-sm text-center">Your code is never stored on our servers. It’s processed in ephemeral containers and destroyed immediately after documentation is generated.</dd>
            </div>
            <div>
              <dt className="text-[#4d6cf7] font-semibold text-center">Which languages are supported?</dt>
              <dd className="text-neutral-400 mt-1 text-sm text-center">Next.js, Python, Go, Rust, Java, C++, C#, PHP, Ruby, and many more.</dd>
            </div>
            <div>
              <dt className="text-[#4d6cf7] font-semibold text-center">Is there a free trial?</dt>
              <dd className="text-neutral-400 mt-1 text-sm text-center">Yes, we offer a free tier for open-source projects. Contact us for details.</dd>
            </div>
          </dl>
        </div>
      </section>
